...
RoutePlanner::RoutePlanner(RouteModel &model, float start_x, float start_y, float end_x, float end_y): m_Model(model) {
    ...
    // Node* closeStartNode = m_Model.FindClosestNode(start_x, start_y);
...
// bool RoutePlanner::compare_(const RouteModel::Node* first, const RouteModel::Node* second){
//     auto f_val = first->g_value + first->h_value;
//     auto s_val = second->g_value + second->h_value;
//     return f_val > s_val;
// }

bool compare_(const RouteModel::Node* first, const RouteModel::Node* second){
    auto f_val = first->g_value + first->h_value;
    auto s_val = second->g_value + second->h_value;
    return f_val > s_val;
}
...
std::sort(this->open_list.begin(), this->open_list.end(),compare_);
